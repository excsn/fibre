...
/// Represents a loggable value, part of a `TelemetryEvent`'s fields.
...
/// The internal structured representation of a log event within `fibre_telemetry`.
#[derive(Debug, Clone)]
...
impl TelemetryEvent {
  /// Creates a new `TelemetryEvent` with minimal required fields.
