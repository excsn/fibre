...
pub(super) struct DebugEvent {
  // We capture less than TelemetryEvent, but what's important for the report
...
pub fn clear_debug_report() {
  ...
  *collector = Default::default();
  println!("[fibre_telemetry] Debug report data cleared.");
}
